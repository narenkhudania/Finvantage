...
const RetirementPlan: React.FC<{ state: FinanceState }> = ({ state }) => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 pb-24">
      {/* Simulation Header */}
      <div className="surface-dark text-white p-10 md:p-16 rounded-[4rem] relative overflow-hidden shadow-2xl">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-teal-600/10 blur-[120px] rounded-full translate-x-1/2 -translate-y-1/2" />
        
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-12">
          <div className="space-y-6 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-500/20 text-teal-400 rounded-full text-[10px] font-black uppercase tracking-widest border border-teal-500/20">
        ...
        <div className="lg:col-span-2 bg-white p-10 md:p-14 rounded-[4rem] border border-slate-200 shadow-sm flex flex-col">
           <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
              <h3 className="text-2xl font-black text-slate-900 flex items-center gap-3">
                 <TrendingUp className="text-teal-600" size={28} /> Compounding Horizon
              </h3>
              <div className="flex gap-4">
                 <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-teal-600" /><span className="text-[9px] font-black text-slate-400 uppercase">Nominal Wealth</span></div>
        ...
        <div className="space-y-8 flex flex-col">
           <div className="bg-white p-10 rounded-[3.5rem] border border-slate-200 shadow-sm flex-1">
              <h3 className="text-xl font-black text-slate-900 mb-10 flex items-center gap-2">
                 <CalendarDays className="text-teal-600" size={24} /> Simulation Events
              </h3>
              <div className="space-y-10 relative">
                 <div className="absolute left-4 top-2 bottom-2 w-1 bg-slate-100 rounded-full" />
                 
                 <div className="relative pl-12 group">
                    <div className="absolute left-2.5 top-1.5 w-4 h-4 rounded-full bg-white border-4 border-teal-600 shadow-lg group-hover:scale-125 transition-transform" />
           ...
           <div className="bg-teal-600 p-10 rounded-[3.5rem] text-white space-y-4 shadow-xl shadow-teal-600/20">
              ...
              <button className="w-full py-4 bg-white text-teal-600 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-teal-50 transition-colors">Apply Strategy</button>
           </div>
        </div>
      </div>
    </div>
