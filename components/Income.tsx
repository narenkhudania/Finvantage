        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="flex items-center justify-between bg-white p-8 rounded-[3rem] border border-slate-200 shadow-sm relative overflow-hidden">
             ...
             <div className="text-right hidden sm:block">
                ...
                <p className="text-3xl font-black text-slate-900">{formatCurrency(totalIncome, currencyCountry)}</p>
             </div>
          </div>
             ...
             <div className="pt-8 border-t border-slate-50 space-y-6">
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <h4 className="text-3xl font-black text-slate-900">{formatCurrency(projectedIncome, currencyCountry)}</h4>
