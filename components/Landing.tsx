    ...
    <div className="min-h-screen text-slate-900 overflow-x-hidden">
      ...
      <section className="relative pt-36 md:pt-52 pb-24 md:pb-32 px-6 md:px-8 overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-5 py-2 md:py-2.5 bg-teal-600 text-white rounded-full text-[8px] md:text-[10px] font-black uppercase tracking-[0.3em] mb-8 md:mb-12 shadow-xl shadow-teal-600/20">
            <Sparkles size={14} className="animate-pulse" /> Precision Wealth Engineering
          </div>
          
          <h1 className="text-5xl md:text-9xl font-black text-slate-950 leading-[1.1] md:leading-[0.85] tracking-tight mb-8 md:mb-10 font-display">
            Plan for Life, <br className="hidden md:block"/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-teal-400">Not Just Money.</span>
          </h1>
          
          <p className="text-lg md:text-3xl text-slate-500 max-w-4xl leading-relaxed mb-12 md:mb-16 font-medium">
            Get the clarity you need to make life's biggest decisions. From <span className="text-teal-600 font-black">buying your first car</span> to achieving <span className="text-teal-600 font-black">FIRE</span>.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full max-w-md md:max-w-none justify-center">
            <button 
              onClick={onStart}
              className="bg-teal-600 text-white px-10 md:px-14 py-6 md:py-8 rounded-[1.5rem] md:rounded-[2.5rem] font-black text-lg md:text-xl flex items-center justify-center gap-3 md:gap-4 hover:bg-teal-700 hover:scale-105 transition-all shadow-[0_20px_60px_-15px_rgba(13,148,136,0.45)] group"
            >
            ...
            <div className="flex items-center gap-4 md:gap-5 px-8 md:px-10 py-6 md:py-8 rounded-[1.5rem] md:rounded-[2.5rem] bg-white border border-slate-100 shadow-xl shadow-slate-200/20">
               <div className="p-2.5 md:p-3 bg-teal-50 text-teal-600 rounded-xl md:rounded-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 md:mb-24 gap-8">
            <div className="max-w-2xl text-left">
               ...
               <h2 className="text-4xl md:text-7xl font-black text-slate-900 mb-6 tracking-tight leading-none">The Core <br/><span className="text-teal-600">Pillars.</span></h2>
               <p className="text-slate-500 text-lg md:text-2xl font-medium leading-relaxed">Six technological anchors that power the FinVantage intelligence engine, ensuring your wealth remains <span className="text-teal-600 font-bold">Resilient and Goal-Oriented.</span></p>
            </div>
            <div className="bg-white p-4 rounded-3xl border border-slate-200 shadow-sm hidden md:block">
               <Activity size={32} className="text-teal-600 animate-pulse" />
            </div>
          </div>
      ...
      <section id="scenarios" className="py-24 md:py-40 px-6 md:px-8 surface-dark relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-teal-600/10 blur-[150px] rounded-full translate-x-1/2 -translate-y-1/2" />
        
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 md:mb-32">
             <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-500/20 text-teal-400 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-6">
                <Zap size={14}/> Pre-Live Your Future
             </div>
             <h2 className="text-4xl md:text-8xl font-black text-white mb-8 tracking-tighter leading-none">The Scenario <span className="text-teal-500">Lab.</span></h2>
            ...
            {[
              ...
              <div key={i} className="bg-white/[0.03] border border-white/10 p-10 md:p-16 rounded-[4rem] group hover:bg-white/[0.05] transition-all relative overflow-hidden flex flex-col justify-between min-h-[480px]">
                   ...
                   <div className="space-y-6">
                      ...
                      <div className="p-8 bg-white/5 rounded-[2.5rem] border border-white/10 space-y-4">
                         <div className="flex items-center gap-2">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-teal-400">Alpha Projection</p>
                         </div>
                ...
                <div className="relative z-10 pt-10 border-t border-white/5 flex items-center justify-between">
                   <button onClick={onStart} className="flex items-center gap-2 text-xs font-black text-white uppercase tracking-[0.3em] hover:text-teal-400 transition-colors group/btn">
      ...
      <section id="pricing" className="py-24 md:py-40 px-6 md:px-8 bg-white text-center">
        <div className="max-w-5xl mx-auto">
          <div className="space-y-6 mb-20 md:mb-32">
             <h2 className="text-4xl md:text-7xl font-black text-slate-950 tracking-tight leading-none">The Pricing <br/><span className="text-teal-600 underline decoration-teal-200 decoration-8 underline-offset-8">Terminal.</span></h2>
          ...
          <div className="relative">
             <div className="absolute inset-0 bg-teal-600 blur-[120px] opacity-10 -z-10 rounded-full" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                   <div className="text-left space-y-10">
                      <div className="space-y-2">
                         ...
                         <p className="text-teal-400 text-sm font-black uppercase tracking-[0.3em]">Full Terminal Access</p>
                      </div>
                   ...
                   <div className="bg-white/5 border border-white/10 p-12 rounded-[4rem] flex flex-col justify-center items-center gap-8 backdrop-blur-xl">
                      ...
                      <div className="w-full pt-8 border-t border-white/5">
                         <button 
                           onClick={onStart}
                           className="w-full py-6 md:py-8 bg-white text-slate-950 rounded-[2rem] md:rounded-[3rem] font-black text-lg md:text-xl hover:bg-teal-500 hover:text-white transition-all shadow-2xl active:scale-95"
                         >
                           Access My Node
                         </button>
                      </div>
      ...
      <section className="py-24 md:py-40 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
           <div className="flex-1 text-left space-y-6">
              <div className="p-4 bg-teal-600 rounded-3xl w-fit text-white shadow-xl shadow-teal-600/20"><Database size={32}/></div>
              <h3 className="text-3xl md:text-5xl font-black text-slate-950 tracking-tight leading-none">Your Wealth DNA, <br/><span className="text-teal-600">Your Storage.</span></h3>
           ...
           <div className="grid grid-cols-2 gap-4 w-full md:w-auto shrink-0">
              {[
                ...
                <div key={i} className="bg-white p-8 rounded-[2.5rem] border border-slate-200 text-center space-y-3 hover:border-teal-400 transition-all">
                   <item.icon size={24} className="text-teal-600 mx-auto" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-16 border-b border-slate-50 pb-16">
             <div className="flex items-center gap-3">
               ...
               <span className="text-2xl font-black tracking-tighter text-slate-900 italic">FinVantage<span className="text-teal-600">.</span></span>
             </div>
             <div className="flex gap-10">
                <a href="#benefits" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-teal-600">Pillars</a>
                <a href="#scenarios" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-teal-600">Lab</a>
                <a href="#pricing" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-teal-600">Plans</a>
                <button onClick={onStart} className="text-[10px] font-black uppercase tracking-widest text-teal-600">Terminal</button>
             </div>
          </div>
